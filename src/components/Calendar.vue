  ...
  data() {
    return {
      ...
      events:[
        ...
        { id: 2, name: "イベント", start: "2021-02-02", end:"2021-02-04", color:"limegreen"},
        { id: 3, name: "会議", start: "2021-02-06", end:"2021-02-06", color:"deepskyblue"},
        { id: 4, name: "有給", start: "2021-02-08", end:"2021-02-08", color:"dimgray"},
        ...
        { id: 14, name: "有給", start: "2021-02-20", end:"2021-02-20", color:"dimgray"},
        ...
        { id: 20, name: "誕生日", start: "2021-02-27", end:"2021-02-27", color:"orange"},
      ]
    };
  },
  computed: {
